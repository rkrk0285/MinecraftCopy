...
#include "MinecraftCopy/MyGameModeBase.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyGameModeBase() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_AGameModeBase();
MINECRAFTCOPY_API UClass* Z_Construct_UClass_AMyGameModeBase();
MINECRAFTCOPY_API UClass* Z_Construct_UClass_AMyGameModeBase_NoRegister();
...
template<> MINECRAFTCOPY_API UClass* StaticClass<AMyGameModeBase>()
{
	return AMyGameModeBase::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_rkrk0_Unreal_Projects_MinecraftCopy_Source_MinecraftCopy_MyGameModeBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyGameModeBase, AMyGameModeBase::StaticClass, TEXT("AMyGameModeBase"), &Z_Registration_Info_UClass_AMyGameModeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyGameModeBase), 1737376032U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_rkrk0_Unreal_Projects_MinecraftCopy_Source_MinecraftCopy_MyGameModeBase_h_975621801(TEXT("/Script/MinecraftCopy"),
	Z_CompiledInDeferFile_FID_Users_rkrk0_Unreal_Projects_MinecraftCopy_Source_MinecraftCopy_MyGameModeBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_rkrk0_Unreal_Projects_MinecraftCopy_Source_MinecraftCopy_MyGameModeBase_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
